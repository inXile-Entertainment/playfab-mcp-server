...
```powershell
$f="$env:TEMP\setup-playfab-mcp.ps1"; gh api repos/inXile-Entertainment/playfab-mcp/contents/setup-playfab-mcp.ps1 -H "Accept: application/vnd.github.raw" > $f; & $f; ri $f
```
