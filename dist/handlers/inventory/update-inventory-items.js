...
const UpdateInventoryItems = async (params) => {
    ...
    const result = await (0, playfab_wrapper_js_1.callPlayerAPI)(playfab_js_1.PlayFabEconomyAPI.UpdateInventoryItems, request, 'UpdateInventoryItems');
    return {
        success: true,
        eTag: result.ETag,
