...
const ExecuteInventoryOperations = async (params) => {
    ...
    const result = await (0, playfab_wrapper_js_1.callPlayerAPI)(playfab_js_1.PlayFabEconomyAPI.ExecuteInventoryOperations, requestWithTags, 'ExecuteInventoryOperations');
    return {
        success: true,
        eTag: result.ETag,
...
exports.ExecuteInventoryOperations = ExecuteInventoryOperations;
